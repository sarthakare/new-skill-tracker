        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-card shadow-card border border-slate-200/80 p-8">
                <div class="text-center mb-6">
                    ...
                    <p class="text-slate-500 mt-1">All fields are required</p>
                </div>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('student.register.post') }}" class="space-y-4" id="student-register-form">
                    @csrf
                    <div>
                        <label for="college_id" class="block text-sm font-medium text-slate-700 mb-1">College</label>
                    ...
                    <div>
                        ...
                        <input type="tel" id="mobile" name="mobile" value="{{ old('mobile') }}" required inputmode="tel"
