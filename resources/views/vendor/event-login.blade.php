                ...
                <form method="POST" action="{{ route('vendor.event.login.post') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" required placeholder="Enter your event password" class="w-full pl-10 pr-4 py-2.5 rounded-input border border-slate-300 focus:ring-2 focus:ring-primary focus:border-primary @error('password') border-red-500 @enderror">
                        </div>
