...
<div class="bg-white rounded-card border border-border shadow-card overflow-hidden">
    <div class="px-5 py-4 border-b border-border bg-primary/5">
        <h2 class="text-lg font-semibold text-slate-800">Session List</h2>
    </div>
                    ...
                    <tr class="border-b border-border odd:bg-slate-50/50 hover:bg-primary/5 transition-colors">
                        ...
                        <td class="px-5 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <a href="{{ route('manager.program.attendance.report', [$program, $session]) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 rounded-button text-sm font-medium text-slate-700 bg-white border border-border hover:bg-slate-50">Generate Report</a>
                            </div>
                        </td>
                    </tr>
                @empty
