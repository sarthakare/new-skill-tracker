...
<div id="attendance-print-document" class="hidden print:block attendance-formal-doc">
    ...
    <table class="attendance-doc-info-table">
        <tr><td class="attendance-doc-label">Subject/program name</td><td>{{ $program->name }}</td></tr>
        @if($program->event)
            <tr><td class="attendance-doc-label">Year/Semester/Event</td><td>{{ $program->event->name }}</td></tr>
        @endif
