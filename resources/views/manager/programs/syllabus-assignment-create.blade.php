    ...
    <div class="p-5">
        <form action="{{ route('manager.program.syllabus.assignments.store', [$program, $subtopic]) }}" method="POST" class="space-y-5 max-w-3xl">
            ...
            <div class="flex flex-wrap items-center gap-2 pt-2">
                <button type="submit" class="inline-flex items-center justify-center rounded-button bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-hover">Save assignment</button>
