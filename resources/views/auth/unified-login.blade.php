                ...
                <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-xs text-slate-500">
                            Use email for Super Admin, College Admin, or Student, or username for Subject/Program Manager / Vendor access
                        </p>
                        @error('username')
                    ...
                    <div>
                        ...
                        <x-password-input left-icon
                            id="password"
                            name="password"
                            required
                            placeholder="Enter your password"
                            class="w-full py-2.5 rounded-input border border-slate-300 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary @error('password') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" />
                        @error('password')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
