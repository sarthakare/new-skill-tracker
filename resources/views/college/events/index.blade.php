                        ...
                        <td class="px-5 py-3 text-right">
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <a href="{{ route('college.events.programs.index', $event) }}"
                                   class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-primary hover:bg-primary/10 transition-colors" title="Semesters/programs for this year/event">
