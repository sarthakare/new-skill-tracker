    ...
    <div class="p-5">
        <form action="{{ route('college.events.store') }}" method="POST" class="space-y-4">
            ...
            <div class="rounded-lg border border-info bg-info/10 px-4 py-3 text-sm text-slate-700 flex items-start gap-2">
                ...
                <span>Year/Event will be created with status <strong>DRAFT</strong>. After saving, add semesters/programs under this year/event and assign Vendor, Independent Trainer, or Internal Manager to each semester/program.</span>
            </div>
