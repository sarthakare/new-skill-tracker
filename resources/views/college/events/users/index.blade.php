                    ...
                    <tbody>
                        @forelse($eventUsers as $eventUser)
                            <tr class="border-b border-border odd:bg-slate-50/50 hover:bg-primary/5 transition-colors">
                                ...
                                <td class="px-5 py-3"><span class="inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium bg-info-light text-info">{{ $eventUser->role }}</span></td>
                        ...
                        @empty
                            <tr><td colspan="4" class="px-5 py-12 text-center text-slate-500">No users assigned to this event.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
