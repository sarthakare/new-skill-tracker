    ...
    <div class="p-5">
        <form action="{{ route('college.independent-trainers.update', $independentTrainer) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone', $independentTrainer->phone) }}" class="w-full rounded-input border border-slate-300 focus:ring-2 focus:ring-primary focus:border-primary">
            </div>
