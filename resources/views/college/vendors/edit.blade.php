        ...
        <form action="{{ route('college.vendors.update', $vendor) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select id="type" name="type" required class="w-full rounded-input border @error('type') border-red-500 @else border-slate-300 @enderror focus:ring-2 focus:ring-primary focus:border-primary">
                    ...
                    <option value="Syllabus" {{ old('type', $vendor->type) === 'Syllabus' ? 'selected' : '' }}>Syllabus</option>
            ...
            <div>
                ...
                <input type="text" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $vendor->contact_phone) }}" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" class="w-full rounded-input border @error('contact_phone') border-red-500 @else border-slate-300 @enderror focus:ring-2 focus:ring-primary focus:border-primary">
