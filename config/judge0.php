...
/**
 * Judge0 language list — keep in sync with what students can pick on the dashboard code runner.
 * IDs are Judge0 language_id values sent to the submissions API.
 */
return [
    'languages' => [
